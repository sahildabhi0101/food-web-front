    ...
    render() {
        return (
            <div className="">
                ...
                {/* style={{paddingTop:'0px'  , height: '150px',position: 'relative', overflow: "hidden" }}
                        ...
                        <div className="t-container">
                            ...
                            <div className="t-box">
                                <div className="t-box-text t-middle-text">
                                    ...
                                    <p><b>OUR FOOD</b> is doing a great job by providing such fresh and healthy food with so much different varities at such reonable prices and most importantly i loved the design
                of their website which just makes us shop with them.</p>
